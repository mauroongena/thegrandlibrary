            ...
            <div className="space-y-6">
              <div className="bg-gray-700/30 rounded-xl p-4 border border-gray-600">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="text-lg font-semibold text-blue-400">Publisher</h3>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-700/30 rounded-xl p-4 border border-gray-600">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h3 className="text-sm font-semibold text-blue-400">Pages</h3>
                  </div>
              ...
              <div className="bg-gray-700/30 rounded-xl p-4 border border-gray-600">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="text-lg font-semibold text-blue-400">Additional Info</h3>
                </div>
                <p className="text-gray-400 text-sm">
                  <strong>Genres:</strong>{" "}
                  {genreNames.length > 0 ? genreNames.join(", ") : "No genre assigned"}
                </p>
              </div>
            </div>
          </div>
