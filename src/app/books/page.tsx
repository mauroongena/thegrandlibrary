...
interface Book {
    ...
    year?: number | null;
    image?: string | null;
    author: { author: { title: string } }[];
    genres: { genre: { title: string } }[];
    loans: { id: number; returnedAt: Date | null }[];
}
            ...
            <div className="max-w-6xl mx-auto">
                <div className="flex justify-between items-center mb-12">
                    <div>
                        ...
                        <p className="text-gray-400 text-lg">Discover your curated library</p>
                    </div>
                    {isAdmin && (
                        <Link
                            href="/books/new"
                                ...
                                <Link href={`/books/${book.id}`} className="text-blue-600">
                                    ...
                                    <div className="space-y-2 text-gray-300">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm">{genreNames}</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <svg
                                                className="w-4 h-4 text-blue-500"
                                    ...
                                    <div className="mt-4">
                                        {book.loans.some((loan) => loan.returnedAt === null) ? (
